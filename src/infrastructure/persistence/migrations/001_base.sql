-- Migration 001: base rlm schema.
--
-- Creates files / chunks / refs / savings tables, their supporting
-- indexes, the chunks_fts virtual table, and the FTS sync triggers.
-- This is the original shape of the rlm index; v2 savings columns and
-- files.mtime_nanos come in later migrations.
...
-- Token savings tracking (base shape; v2 columns come in migration 002).
