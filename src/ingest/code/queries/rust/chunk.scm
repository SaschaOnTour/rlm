    ...
    (impl_item type: (generic_type type: (type_identifier) @impl_name)) @impl_def
    (impl_item type: (scoped_type_identifier name: (type_identifier) @impl_name)) @impl_def
    (impl_item type: (generic_type type: (scoped_type_identifier name: (type_identifier) @impl_name))) @impl_def
